...
from .views import ProductListView, ProductDetailView, ProductCreateView, OrderCreateView, OrderDetailView, MarketplaceView, FarmerProductListView, FarmerOrdersView, BuyerOrdersView, ProductEditView
urlpatterns = [
